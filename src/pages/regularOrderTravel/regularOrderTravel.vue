...
<script>
import { regularTravel1HeadSearch, regularTravel1TableHead } from '@/utils/data'
...
export default {
  ...
  data () {
    return {
      formModules: regularTravel1HeadSearch,
      tableList: [],
      page: {
        pageNum: 1,
        pageSize: 10,
  ...
  mounted () {
    ...
    regularTravel1HeadSearch[3].data = [thisDay.dayStr, thisDay.dayStr]
    ...
    this.$emit('getInfo', regularTravel1HeadSearch)
    this.$emit('getTable', regularTravel1TableHead)
  ...
  methods: {
    ...
    getTableData (params) {
      ...
      net.apiGet(api.orderManage.regularTravelDetailList, params).then(data => {
    ...
    exportOrder () {
      ...
      str = api.orderManage.regularTravelDetailOut + '?' + str
